...
@rate_limit()
def solutions():
    """Display the solutions page with user's answers and correct answers."""
    ...
    try:
        ...
        # Get questions with their original indices
        ...
        # Get score and total for the template
        score = session.get("score", 0)
        total_questions = len(selected_indices)
            
        return render_template(
            "solution.html",  # Make sure this matches your template filename
